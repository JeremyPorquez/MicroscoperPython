...
class Ui_Zaber(object):
    def setupUi(self, Zaber):
        ...
        self.gridLayout.addWidget(self.incSpinbox, 2, 2, 1, 1)
        ...
        self.spectroScanButton = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.spectroScanButton.setObjectName("spectroScanButton")
        self.gridLayout.addWidget(self.spectroScanButton, 5, 1, 1, 1)
    ...
    def retranslateUi(self, Zaber):
        ...
        self.spectroScanButton.setText(_translate("Zaber", "Spectroscan"))
