...
class SpectrometerExtension:
    ...
    # UNCOMMENT THIS IF FAIL
    # def waitForResponse(self,sender=None):
    #     if sender is not None:
    #         self.waitingForResponse = True
    #         message = "spectrometer.waitForResponse(receiver='%s',command='spectrometer.waitingForResponse = False')"
    #         self.parent.send(message%(sender))
